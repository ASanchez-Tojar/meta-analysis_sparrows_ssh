...
tiff(#"plots/main/Figure2_Funnel_plots.tiff",
     "plots/supplements/FigureS2_Funnel_plots.tiff",
...
text(1,56,"published 1",adj = 0 ,cex=1.25)
...
text(1,56,"published 2",adj = 0 ,cex=1.25)
...
#      pch=19,cex=1.25,cex.axis=1.25,cex.lab=1.5,
#      # xlab="meta-analytic residuals",
#      # ylab="precision (1 / VZr)",
#      # xlim=c(-2.5,2.5),
#      # ylim=c(0,60),
#      yaxt="n",
#      xlim=c(-3,3),
...
# abline(v=0, lwd=1, lty=2)
# 
# #text(1.3,56,"meta 3",adj = 0 ,cex=1.5)
...
# abline(v=0, lwd=1, lty=2)
# 
# #text(1.3,56,"meta 4",adj = 0 ,cex=1.5)
